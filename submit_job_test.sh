...
#SBATCH -c 16
#SBATCH --mem=64GB
#SBATCH --job-name=variantpiper_test
...
# ============================================================
# VariantPiper — SLURM Submission Script (test data)
# ============================================================
# Runs the full pipeline on the bundled test dataset
# (10,000 reads in test_data/).
#
# Prerequisites:
#   - BWA-MEM2 index must already exist (resources/reference/)
#   - DeepVariant Singularity image must already exist
#   - Delly exclusion list must already exist (resources/delly/)
#   Run install.sh first if any of these are missing.
#
# Submit with: sbatch submit_job_test.sh
# ============================================================
